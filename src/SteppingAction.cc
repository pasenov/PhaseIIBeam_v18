...
void SteppingAction::UserSteppingAction(const G4Step* step)
{
 //get volume of the current step
  ...
  G4double xp_after,yp_after,zp_after,x_after,y_after,z_after,xp,yp,zp,x,y,z;
  ...
  //geometry parameters
  G4double Det1SizeZ, Det2SizeZ, Dist, Strip1Depth, Strip1Length, Strip2Depth, Strip2Length, StripDist, StripWidth, xAbs, XangleDUT, XangleBPIX, YangleBPIX, ElField1, ElField2;
  G4int div;
  ...
  //position if the modules weren't rotated
  xp = xp_after;
